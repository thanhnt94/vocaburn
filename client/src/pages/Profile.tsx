...
export default function Profile() {
  ...
  return (
    <div className="fixed inset-0 top-0 bottom-[calc(56px+env(safe-area-inset-bottom))] md:relative md:inset-auto md:top-auto md:bottom-auto md:h-full md:min-h-0 md:w-full flex flex-col bg-[#F8FAFC] dark:bg-[#0b0f19] overflow-hidden text-left select-none">
      {/* ═══════════ TOP UNIFIED HEADER ═══════════ */}
      <div className="shrink-0 z-30 bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl border-b border-slate-200/70 dark:border-slate-800 shadow-2xs px-3.5 sm:px-6 lg:px-8 xl:px-10 py-3 sm:py-3.5">
        <div className="w-full max-w-[1700px] 2xl:max-w-[1900px] mx-auto flex items-center justify-between gap-3 text-left">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1 truncate">
                Personal Progress, Stats & Badges
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Link 
              to="/decks"
              className="px-3 py-1.5 rounded-xl bg-orange-50 hover:bg-orange-100 text-orange-600 flex items-center gap-1.5 text-xs font-black border border-orange-200/60 active:scale-95 transition-all"
            >
            ...
            <Link 
              to="/settings"
              className="w-9 h-9 rounded-xl bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-600 active:scale-95 transition-all border border-slate-200/60"
              title="Settings"
            >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar">
        <div className="px-3.5 sm:px-6 max-w-lg mx-auto py-4 md:py-6 space-y-3.5 pb-12">
        ...
        <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-xs border border-slate-100 relative overflow-hidden">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="w-full bg-slate-50 rounded-xl p-2 border border-slate-100">
                <div className="flex items-center justify-between text-[10px] font-bold text-slate-500 mb-1">
                  <span>Level {gamify.level} Progress</span>
          ...
          <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-slate-100">
            <div className="bg-orange-50/50 rounded-xl p-2 text-center border border-orange-100/60">
              ...
              <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block mt-0.5">Day Streak</span>
            </div>
            ...
            <div className="bg-amber-50/50 rounded-xl p-2 text-center border border-amber-100/60">
              ...
              <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block mt-0.5">Total XP</span>
            </div>
            ...
            <div className="bg-emerald-50/50 rounded-xl p-2 text-center border border-emerald-100/60">
              ...
              <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block mt-0.5">Badges</span>
            </div>
          </div>
        </div>
                ...
                <div className="mt-2 flex flex-col items-center">
                  ...
                  <div className="w-full bg-slate-50 rounded-2xl p-4 border border-slate-100 text-left">
                    ...
                    <p className="text-[10px] font-medium text-slate-400">
                      {selectedBadge.is_unlocked 
                        ? 'Excellent! You have completed this challenge. 🎉'
                        : `Current progress: ${Math.round(selectedBadge.progress)}% towards completion.`}
                    </p>
                  </div>
                </div>
              </motion.div>
