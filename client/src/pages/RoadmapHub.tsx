                    ...
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 mt-3 text-[10px] font-bold text-slate-400 flex-wrap">
                          ...
                          <span>📅 Dự kiến xong: <strong className="text-slate-600">{(s.unlearned_cards === 0 || (s.total_cards > 0 && (s.learned_cards || 0) >= s.total_cards)) ? 'Đã hoàn thành 🎉' : (s.estimated_completion_date || '—')}</strong></span>
