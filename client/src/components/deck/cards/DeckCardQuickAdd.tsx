  ...
  const handleToggleColumn = (colKey: string) => {
    if (activeColumns.includes(colKey)) {
      if (activeColumns.length <= 1) {
        alert('Please keep at least 1 column active!')
        return
      }
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  title="Select columns to show for quick add"
                >
                  ...
                  <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80 space-y-2 text-xs">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-600 text-[11px]">
                        Toggle columns for quick entry (auto-saved to settings):
                      </span>
                      <button
                        type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-2.5">
              ...
              <div className="flex items-center justify-between gap-2">
                <p className="text-[10px] text-slate-400 font-medium hidden sm:block">
                  💡 Press Enter to save and immediately add the next card
                </p>
                ...
                >
                  ...
                  <span>{isAdding ? 'Saving...' : '+ Add Card'}</span>
                </button>
              </div>
            </form>
          </div>
