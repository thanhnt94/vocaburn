...
import { ChevronLeft, ChevronRight, X, ArrowRight, CornerDownLeft } from 'lucide-react'
        ...
        {isJumpModalOpen && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="w-full max-w-xs bg-white rounded-3xl shadow-2xl relative z-10 p-5 border border-slate-100 text-left flex flex-col gap-4"
            >
              {/* Header */}
                ...
                {totalPages > 2 && (
                  <div className="flex items-center justify-center gap-2">
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-600 text-[10px] font-bold transition-all"
                    >
                      Trang 1
                    </button>
                    {totalPages > 4 && (
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-600 text-[10px] font-bold transition-all"
                      >
                        Trang giữa ({Math.ceil(totalPages / 2)})
                      </button>
                    )}
                    <button
                      type="button"
