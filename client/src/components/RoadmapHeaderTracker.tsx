        ...
        <AnimatePresence mode="wait">
          ...
          {viewMode === 0 ? (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 bg-slate-800/80 px-2 py-0.5 rounded-md border border-slate-700/80 shrink-0">
                <div className="relative w-4.5 h-4.5 flex items-center justify-center shrink-0">
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-[7px] font-black text-amber-300">{overallPercent}%</span>
                </div>
                {hasSubProg && (
              ...
              {/* Streak */}
              <div className="flex items-center gap-1 bg-orange-500/10 border border-orange-500/30 px-2 py-0.5 rounded-md text-orange-400 font-black text-[10.5px] shrink-0">
