          ...
          <div className="flex items-center gap-1.5 shrink-0 ml-auto">
            {onOpenCustomize && (
              <button
                ...
                className="w-7 h-7 rounded-xl bg-slate-100 hover:bg-orange-50 hover:text-orange-600 text-slate-500 flex items-center justify-center transition-colors cursor-pointer shadow-2xs"
      ...
      <div className="px-3.5 sm:px-4 py-2 bg-white/95 backdrop-blur-xs flex items-center justify-between flex-shrink-0 text-xs font-semibold text-slate-500 border-b border-slate-100/90 gap-2">
        ...
        <div className="flex items-center gap-2 shrink-0 ml-auto">
          ...
          <Link 
            ...
            className="text-xs font-bold text-orange-600 hover:text-orange-700 flex items-center gap-0.5 transition-colors cursor-pointer shrink-0"
          >
            <span>Details</span>
