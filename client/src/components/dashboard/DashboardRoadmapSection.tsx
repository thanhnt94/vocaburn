...
export function DashboardRoadmapSection({
      ...
      <div className="h-full w-full flex flex-col overflow-hidden text-left select-none">
        ...
        <div className="px-3.5 sm:px-4 py-2 bg-white/95 backdrop-blur-xs flex items-center justify-between flex-shrink-0 text-xs font-semibold text-slate-500 border-b border-slate-100/90 gap-2">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-amber-50 text-amber-950 border border-amber-300/80 rounded-md text-[10px] sm:text-[11px] font-black shadow-2xs shrink-0">
  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden text-left select-none">
      ...
      <div className="px-3.5 sm:px-4 py-2 bg-white/95 backdrop-blur-xs flex items-center justify-between flex-shrink-0 text-xs font-semibold text-slate-500 border-b border-slate-100/90 gap-2">
        <div className="flex items-center gap-2 min-w-0">
          {/* Deck Switcher (#1/3 with crisp squared buttons) */}
          {totalDecks > 1 ? (
            <div className="flex items-center gap-1 bg-slate-100/90 p-0.5 rounded-md border border-slate-200/80">
              <button
                ...
                className={cn(
                  ...
                  safeIdx === 0 ? "text-slate-300 cursor-not-allowed" : "text-slate-700 bg-white hover:bg-slate-50 border border-slate-200/80 cursor-pointer shadow-2xs"
                )}
                title="Previous deck"
              >
                <ChevronLeft className="w-3 h-3" />
              </button>
              <span className="text-[11px] font-black text-slate-800 px-1.5 tabular-nums">
              ...
              <button
                ...
                className={cn(
                  "w-5 h-5 rounded flex items-center justify-center transition-all",
                  safeIdx === totalDecks - 1 ? "text-slate-300 cursor-not-allowed" : "text-slate-700 bg-white hover:bg-slate-50 border border-slate-200/80 cursor-pointer shadow-2xs"
                )}
                title="Next deck"
              >
          ...
          {!st.all_done ? (
            ...
            <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-50 text-emerald-950 border border-emerald-300/80 rounded-md text-[10px] sm:text-[11px] font-black shadow-2xs shrink-0">
        ...
        <div className="flex items-center gap-2 shrink-0 ml-auto">
          ...
          <Link 
            ...
            className="text-xs font-bold text-orange-600 hover:text-orange-700 flex items-center gap-0.5 px-2 py-1 rounded-md hover:bg-orange-50 border border-transparent hover:border-orange-200 transition-all cursor-pointer shrink-0"
          >
            <span>Details</span>
